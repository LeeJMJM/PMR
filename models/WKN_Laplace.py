"""
modefied by Jiaming Li on 2025/1/21
"""
...
class Laplace_fast(nn.Module):
    ...
    def __init__(self, out_channels, kernel_size, in_channels=1):
        ...
        # https://github.com/HazeDT/WaveletKernelNet/issues/3
        self.a_ = nn.Parameter(torch.linspace(1, 10, out_channels).view(-1, 1))
        self.b_ = nn.Parameter(torch.linspace(0, 10, out_channels).view(-1, 1))
    ...
    def forward(self, waveforms):
        ...
        # https://github.com/HazeDT/WaveletKernelNet/issues/3
        p1 = (time_disc.cuda() - self.b_.cuda()) / (self.a_.cuda() + 1e-8)  # improved version: better
        ...
        return F.conv1d(waveforms, self.filters, stride=2, padding=7, dilation=1, bias=None, groups=1)
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.Iden(x)  # do nothing, only for easy CAM operations
...
def Laplace_ResNet(pretrained=False, **kwargs):
